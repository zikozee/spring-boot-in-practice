package com.sbip.ch04.metrics;

import com.sbip.ch04.Ch04Application;
import com.sbip.ch04.metrics.couseTracker.service.CourseService;
import com.sbip.ch04.metrics.couseTracker.service.DefaultCourseService;
...
public class CourseTrackerMetricsConfiguration {
    ...
    public Gauge createCourseGauge(MeterRegistry meterRegistry){
        return Gauge.builder("api.courses.created.gauge",
                        () -> Ch04Application.getContext().getBean("defaultCourseService", DefaultCourseService.class).count())
                .description("Total number of courses created")
                .register(meterRegistry);
    }
