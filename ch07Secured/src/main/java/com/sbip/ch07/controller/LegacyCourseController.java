...
public class LegacyCourseController {
	...
	public Iterable<LegacyCourseDto> getAllCourses(@AuthenticationPrincipal Jwt jwt) {
	...
	public LegacyCourseDto getCourseById(@PathVariable("id") long courseId, @AuthenticationPrincipal Jwt jwt) {
		String author = jwt.getClaim("user_name");
